...
import type { MenuItem } from "../src/components/TopMenu";
...
export function PROP_development_options() {
  let outstr: string =
    "<br><h2>Expert ontwikkel opties, Gebruik enkel indien u weet wat u doet.</h2>" +
...
globalThis.loadFileFromText = () => {
  let str: string = (
    document.getElementById("HL_loadfromtext") as HTMLInputElement
  ).value;
  EDStoStructure(str);
